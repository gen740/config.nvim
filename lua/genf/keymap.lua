...
map('t', '<esc>sh', require('genf.toggleshell').ToggleTerm)
...
-- LSP
map('n', '<space>f', function() vim.lsp.buf.format { async = true, timeout_ms = 1000, filter = function(client) return client.name ~= "tsserver" and client.name ~= "texlab" end } end)
